...
## Project Structure
    ...
    ├── restless_limit_41034  # Django project configurations
...
1. Clone this repo and `cd restless_limit_41034`
...
2. Clone this repo and `cd restless_limit_41034`
