"""
Django settings for restless_limit_41034 project.
...
ROOT_URLCONF = 'restless_limit_41034.urls'
...
WSGI_APPLICATION = 'restless_limit_41034.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_limit_41034 API",
    "DESCRIPTION": "API documentation for restless_limit_41034 App",
    "VERSION": "v1",
}
